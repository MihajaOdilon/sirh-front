...
import ListInterviews from './components/entity/interview/ListInterviews';
...
import ChoosedCandidate from './components/entity/candidate/ChoosedCandidate';
import CandidateResults from './components/entity/candidate/CandidateResults';
      ...
      <Route path="/dashboard" element = { <DashboardPage/> }>
        ...
        <Route path="joboffers" element={<JobOffer/>}>
            ...
            <Route path="add" element={<AddJobOffer/>}></Route>
                <Route path=":idjoboffer/candidates" element={<CandidateByJobOffer/>}>
                    <Route index=":idjoboffer/candidates" element={<ListCandidateByJobOffer/>}></Route>
                ...
                <Route path=":idjoboffer/choosedcandidates" element={<ChoosedCandidate/>}></Route>  
                <Route path=":idjoboffer/candidateresults" element={<CandidateResults/>}></Route>
                <Route path=":idjoboffer/interviews" element={<Interview/>}>
                    <Route path=":idcandidate/addresponse" element={<AddCandidateResponses/>}></Route>
                    <Route path=':idcandidate' element={<ListInterviews/>}></Route>
                </Route>
                <Route path=":idjoboffer/questions" element={<Questions/>}>
